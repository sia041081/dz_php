...
//        var_dump($_POST);
        ...
        $query = 'INSERT INTO goods (`name_product`, `descript_product`, `price`, `img_product`, `category`)
VALUES (?, ?, ?, ?, ?);';
        $sql = mysqli_prepare($connection_shop, $query);
        mysqli_stmt_bind_param($sql, "ssdsd", $name_product, $descript_product, $price, $imgUrl, $category);
